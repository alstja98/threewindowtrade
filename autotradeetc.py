...
while True:
    try:
        ma30 = get_ma30("KRW-ETC")
        ma60 = get_ma60("KRW-ETC")
        ma120 = get_ma120("KRW-ETC")
        beforema120 = get_before_ma120("KRW-ETC")
        before_slowd = get_before_slowd("KRW-ETC")
        slowd = get_slowd("KRW-ETC")
