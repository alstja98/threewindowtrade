...
while True:
    try:
        ...
        beforema120 = get_before_ma120("KRW-BTC")
        before_slowd = get_before_slowd("KRW-BTC")
        slowd = get_slowd("KRW-BTC")
        ...
        if  (beforema120 < ma120) and (slowd >= 25) and (before_slowd < 25) and\
            ...
            doge = get_balance("BTC")
            if doge > 0.00008:
                upbit.sell_market_order("KRW-BTC", doge*0.9995)
